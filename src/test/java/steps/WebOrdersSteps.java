...
public class WebOrdersSteps {
    ...
    public void user_validates_appliation_is_logged_in() {
    ...
    @Then("user validates total is calculated property for quantity {int}")
    public void user_validates_total_is_calculated_property_for_quantity(Integer quantity) {
    ...
    public void userValidatesOrderAddedToListOfOrders() throws InterruptedException {
       ...
       //String actualName=webOrdersHomePage.numberOfRows.get(1).getAttribute("value");
